...
class Calculations {
  /**
   * @param {Object{tableEl: string, currencyAttr: string}} selectors: Element selectors.
   */
  constructor(selectors) {
    this.tableEl = document.querySelector(selectors.table);
    this.currencyAttr = selectors.attr;
  }
